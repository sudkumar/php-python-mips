...
literal = ['IDENTIFIER','CONST_DECIMAL','CONST_HEX', 'CONST_OCTAL', 'CONST_BINARY', 'CONST_DOUBLE','CONST_STRING', 'START_TAG', 'END_TAG']
...
operators = ['PLUS','MINUS','MULT','DIV','MOD', 'EXPONENT',
		...
		# other operators: ; ( ) [ ] { } -> , ? :
		'SEMICOLON','LPAREN','RPAREN','LBRACKET','RBRACKET','LBRACE','RBRACE','ACCESS_OP','COMMA',
		'COND_OP', 'COND_COLON',
		]
